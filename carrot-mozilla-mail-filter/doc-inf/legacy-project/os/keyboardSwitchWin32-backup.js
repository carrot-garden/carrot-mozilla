...
//wrapper.Register("USER32.DLL", "GetActiveWindow", "i=l", "f=s", "r=h");
//wrapper.Register("USER32.DLL", "SetActiveWindow", "i=h", "f=s", "r=h");
//wrapper.Register("USER32.DLL", "GetForegroundWindow", "i=l", "f=s", "r=h");
//wrapper.Register("USER32.DLL", "GetWindowInfo", "i=hp", "f=s", "r=u");

//var handle = wrapper.GetForegroundWindow(0); 
//wshShell.Popup( 'GetForegroundWindow: ' + handle );

//var handle = wrapper.SetActiveWindow( handle ); 
//wshShell.Popup( 'SetActiveWindow: ' + handle );
