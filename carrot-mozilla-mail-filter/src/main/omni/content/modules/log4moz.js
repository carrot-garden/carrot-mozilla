...
/*
 * LogMessage Encapsulates a single log event's data
 */
...
/*
 * Logger Hierarchical version. Logs to all appenders, assigned or inherited
 */
...
/*
 * LoggerRepository Implements a hierarchy of Loggers
 */
...
/*
 * Formatters These massage a LogMessage into whatever output is desired Only
 * the BasicFormatter is currently implemented
 */
...
/*
 * Appenders These can be attached to Loggers to log to different places Simply
 * subclass and override doAppend to implement a new one
 */
...
/*
 * DumpAppender Logs to standard out
 */
...
/*
 * ConsoleAppender Logs to the javascript console
 */
...
/*
 * RotatingFileAppender Similar to FileAppender, but rotates logs when they
 * become too large
 */
