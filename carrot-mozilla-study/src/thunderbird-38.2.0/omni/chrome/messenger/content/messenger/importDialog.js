...
function next()
{
  ...
  case "0":
    ...
    {
//@line 1025 "/builds/slave/tb-rel-c-esr38-lx_bld-00000000/build/mailnews/import/content/importDialog.js"
      window.openDialog("chrome://messenger/content/migration/migration.xul",
                        "", "chrome,dialog,modal,centerscreen");
//@line 1031 "/builds/slave/tb-rel-c-esr38-lx_bld-00000000/build/mailnews/import/content/importDialog.js"
      close();
    }
    else
    {
