...
WeaveCrypto.prototype = {
    ...
    initNSS : function() {
        ...
        var nsslib;
//@line 140 "/builds/slave/tb-rel-c-esr38-lx_bld-00000000/build/mozilla/services/crypto/modules/WeaveCrypto.js"
        let file = Services.dirsvc.get("GreBinD", Ci.nsILocalFile);
        file.append(path);
        this.log("Trying NSS library with path " + file.path);
        nsslib = ctypes.open(file.path);
//@line 145 "/builds/slave/tb-rel-c-esr38-lx_bld-00000000/build/mozilla/services/crypto/modules/WeaveCrypto.js"
