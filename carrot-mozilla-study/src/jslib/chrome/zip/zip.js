if (typeof(JS_LIB_LOADED)=='boolean') 
{
  ...
  {
    ZipReader : null,
    ZipPath   : jslibConstructor("@mozilla.org/file/local;1", "nsILocalFile", "initWithPath"),
    hasWriter : false,
    ZipWriter : null,
    zipW      : null,
    ...
    init : function ()
    {
      try 
      {
        ...
        this.ZipReader = this.mZip = jslibCreateInstance(JS_ZIP_CID, "nsIZipReader");
    ...
    hasEntry : function (aZipEntry)
    {
      var rv = false;

      try 
      {
        rv = this.mZip.hasEntry(aZipEntry);
      } 
        catch (e) { jslibError(e); }
