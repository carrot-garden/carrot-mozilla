...
function next()
{
  ...
  case "0":
    ...
    {
//@line 960 "/buildbot/linux_build_release/build/mailnews/import/content/importDialog.js"
      window.openDialog("chrome://messenger/content/migration/migration.xul",
                        "", "chrome,dialog,modal,centerscreen");
//@line 966 "/buildbot/linux_build_release/build/mailnews/import/content/importDialog.js"
      close();
    }
    else
    {
